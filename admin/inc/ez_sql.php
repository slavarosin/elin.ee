<?php
	...
	define("EZSQL_DB_USER", "virt1545usr");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "RCaf35");		// <-- mysql db password
	define("EZSQL_DB_NAME", "virt1545");		// <-- mysql db pname
	define("EZSQL_DB_HOST", "d1021.mysql.zone.ee");	// <-- mysql server host
