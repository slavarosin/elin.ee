<?php /* Smarty version 2.6.9, created on 2005-05-04 16:59:31
         compiled from galerii.tpl */ ?>
...
<div id="hoidja">
  ...
  <div id="main">
	<p><?php echo $this->_tpl_vars['gallery_title']; ?>
</p>
...
?>
        ...
        <td width="50%">
		  <table width="100%" border="0" cellspacing="1" cellpadding="3">
		    <tr>
			  <td><img src="./pics/<?php echo $this->_tpl_vars['pildid'][$this->_sections['galerii']['index']]['link']; ?>
" border="1" width="270" height="200" alt=""></td>
			</tr>
		    <tr>
			  <td><?php if ($this->_tpl_vars['pildid'][$this->_sections['galerii']['index']]['gallery_id']): ?><a href="index.php?c=4&galerii=<?php echo $this->_tpl_vars['pildid'][$this->_sections['galerii']['index']]['gallery_id']; ?>
" class="rollover"><?php echo $this->_tpl_vars['pildid'][$this->_sections['galerii']['index']]['description']; ?>
</a><?php else:  echo $this->_tpl_vars['pildid'][$this->_sections['galerii']['index']]['description'];  endif; ?></td>
			</tr>
		  </table>
		</td>
	  <?php if ($this->_sections['galerii']['iteration'] % 2 == 0): ?>
      <tr>
      </tr>
	  <?php endif; ?>
	    <?php endfor; endif; ?>
