 ...
 * email_message.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/mimemessage/email_message.php,v 1.46 2004/07/08 08:33:55 mlemos Exp $
 *
 *
 */
...
<class>
	...
	<version>@(#) $Id: email_message.php,v 1.46 2004/07/08 08:33:55 mlemos Exp $</version>
	...
	<documentation>
		...
		<usage>To used this class just create a new object as follows, set any
			...
			<b>- Embed images in HTML messages</b><paragraphbreak />
			...
			is composed by creating the HTML message part with the
			<functionlink>CreateHTMLPart</functionlink> or the
			<functionlink>CreateQuotedPrintableHTMLPart</functionlink> functions,
			then create the image file part with the
			<functionlink>CreateFilePart</functionlink> function, and finally use
			the <functionlink>CreateRelatedMultipart</functionlink> function to
			...
			<b>- Sending messages to many recipients</b><paragraphbreak />
			There are several alternatives to send messages to many
			recipients. One way consists on specifying all recipient addresses
			with the <tt>Bcc</tt> header, separating the addresses with commas
			(,). This way you only need to send one message that is distributed
			to all recipients by your mail transfer system.<paragraphbreak />
...
{metadocument}
	<variable>
		<name>mailer</name>
		<type>STRING</type>
		<value>http://www.phpclasses.org/mimemessage $Revision: 1.46 $</value>
		<documentation>
...
{/metadocument}
*/
	var $mailer='http://www.phpclasses.org/mimemessage $Revision: 1.46 $';
	...
	<function>
		...
		<documentation>
			<purpose>Set the value of an header that is meant to represent the
				...
				meant mostly to set the <tt>From</tt> and <tt>To</tt>
				headers.</purpose>
